...
class IntervalStrategyConfig(BaseModel):
    ...
    position_direction: Position direction (1=short only, 2=both, 3=long only)
    """
    ...
    position_direction: int = Field(2, ge=1, le=3, description="Position direction (1=short only, 2=both, 3=long only)")
