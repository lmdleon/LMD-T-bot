...
TODO LIST
-тейкпрофит величину вынести в конфиг
-подумать, как вычислять размер позиции в зависимости от депо
-сохранять список сработавших стоплосов в БД? чтобы рестарт не терял этот список!!!!!
-смотреть тренд недельный и не входить против него
-может быть еще как-то ограничить вхождение по направлению (в пятницу не лонговать и тп)
